...
class NiveauController extends Controller
{
    public function index(){
       ...
       if($user){
            ...
            $niveau = niveau::orderBy('nom_niveau')->get();
    ...
    public function search($value){
        ...
        if($user){
            ...
            $niveau = niveau::where('nom_niveau', 'like', "%$value%")->get();
    ...
    public function show($niveau_id){
        ...
        if($users){
            ...
            $niveau = niveau::where('id',$niveau_id)->first();
    ...
    public function update(Request $request, $niveau_id){
        ...
        if($users){
            ...
            if($users->roles == "Administrateurs"){
                ...
                $niveau_update = niveau::find($niveau_id);
                    ...
                    $validator = Validator::make($request->all(), [
                        ...
                        if($validator->fails()){
                            ...
                            if($verification_niveau){
                                ...
                                $get_niveau_existe = niveau::where('nom_niveau', $nom_niveau)->first();
